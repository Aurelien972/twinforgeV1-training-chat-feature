/*
  ...
  ## Summary
  Adds a preference field to control glassmorphism and heavy visual effects in the UI. 
  This allows users with low-performance devices (like iPhone 8) to disable resource-intensive 
  visual effects while maintaining full functionality and color identity.
  ...
  ## Use Case
  - Users with older devices (iPhone 8, older Android) can disable glass effects for better performance
